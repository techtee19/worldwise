// "https://api.bigdatacloud.net/data/rev erse-geocode-client?latitude=0&longitude=0"
...
export function convertToEmoji(countryCode) {
  const codePoints = countryCode
    .toUpperCase()
    .split("")
    .map((char) => 127397 + char.charCodeAt(0)); // Fix: Add (0) parameter
    ...
    function () {
      ...
      async function fetchCityData() {
        try {
          ...
          if (!data.countryCode)
            throw new Error(
              "That's not a valid location. Cllick on somewhere else 😉"
            );
